...
#Loading message
print("....Navigating to the Anheuser-Busch webpage...")

#Open page and wait...
driver.get("https://www.anheuser-busch.com/privacy-policy.html")  
time.sleep(1)
driver.execute_script("window.scrollTo(0, window.scrollY + 400)")
#https://abi-dev-busch-brand.adobecqms.net/privacy-policy.html
###############################################################################################
...
#############################################################################
#####        PRE CHANGE - REMOVE THIS IF RUNNING POST-VALIDATION        #####      
#############################################################################
#image_name = '.\\validation-screenshots\\'+driver.current_url+'_before_validation.png'

#############################################################################
#####        PRE CHANGE - REMOVE THIS IF RUNNING PRE-VALIDATION        #####      
#############################################################################
